        ...
        <div className="container">
                <div className="row">
                    ...
                    <div className="card col-lg-4 col-12 mt-5 d-flex" style={{ display: 'flex', flexDirection: 'row', border: 'none', backgroundColor: 'rgb(229 239 233)', width: '25rem' }}>
                        ...
                        <div className="content card-body my-4" style={{ display: 'flex', flexDirection: 'column'}}>
                            <h4 className='card-title' style={{ fontWeight: '900', letterSpacing: '0.1rem', lineHeight: '35px', marginBottom: '7.6rem' }}>OPERATING SYSTEM </h4>
                            <p className="card-text mt-2">
                                Rating: <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                    ...
                    <div className="card col-lg-4 col-12 mt-5 d-flex mx-5" style={{ display: 'flex', flexDirection: 'row', border: 'none', backgroundColor: 'rgb(229 239 233)', width: '25rem' }}>
                        ...
                        <div className="content card-body my-4" style={{ display: 'flex', flexDirection: 'column'}}>
                            <h4 className='card-title' style={{ fontWeight: '900', letterSpacing: '0.1rem', lineHeight: '35px', marginBottom: '2.8rem' }}>COMPUTER NETWORKS</h4>
                            <p className="card-text mt-5">
                                Rating: <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                    ...
                    <div className="card col-lg-4 col-12 mt-5 d-flex" style={{ display: 'flex', flexDirection: 'row', border: 'none', backgroundColor: 'rgb(229 239 233)', width: '25rem' }}>
                        ...
                        <div className="content card-body my-4" style={{ display: 'flex', flexDirection: 'column'}}>
                            <h4 className='card-title' style={{ fontWeight: '900', letterSpacing: '0.1rem', lineHeight: '35px' }}>ObJECT ORIENTED PROGRAMMING (OOPS)</h4>
                            <p className="card-text mt-5">
                                Rating: <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                    ...
                    <div className="card col-lg-4 col-12 mt-5 d-flex" style={{ display: 'flex', flexDirection: 'row', border: 'none', backgroundColor: 'rgb(229 239 233)', width: '25rem' }}>
                        ...
                        <div className="content card-body my-4" style={{ display: 'flex', flexDirection: 'column'}}>
                            <h4 className='card-title' style={{ fontWeight: '900', letterSpacing: '0.1rem', lineHeight: '35px', marginBottom: '2.9rem' }}>MATHEMATICS-I</h4>
                            <p className="card-text mt-5">
                                Rating: <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                    ...
                    <div className="card col-lg-4 col-12 mt-5 d-flex mx-5" style={{ display: 'flex', flexDirection: 'row', border: 'none', backgroundColor: 'rgb(229 239 233)', width: '25rem' }}>
                        ...
                        <div className="content card-body my-4" style={{ display: 'flex', flexDirection: 'column'}}>
                            <h4 className='card-title' style={{ fontWeight: '900', letterSpacing: '0.1rem', lineHeight: '35px', marginBottom: '5.3rem' }}>MATHEMATICS-II</h4>
                            <p className="card-text mt-2">
                                Rating: <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                                <span className="fa fa-star"></span>
                    ...
                    <div className="card col-lg-4 col-12 mt-5 d-flex" style={{ display: 'flex', flexDirection: 'row', border: 'none', backgroundColor: 'rgb(229 239 233)', width: '25rem' }}>
                        ...
                        <div className="content card-body my-4" style={{ display: 'flex', flexDirection: 'column'}}>
                            <h4 className='card-title' style={{ fontWeight: '900', letterSpacing: '0.1rem', lineHeight: '35px' }}>DISCRETE MATHEMATICS</h4>
                            <p className="card-text mt-5">
                                Rating: <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
                                <span className="fa fa-star checked"></span>
